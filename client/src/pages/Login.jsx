    ...
    <style>{`
     ...
     <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                <div className="rainbow relative z-0 overflow-hidden p-0.5 flex items-center justify-center rounded-full hover:scale-105 transition duration-300 active:scale-100">
                    <button type="submit" className="w-full h-11 rounded-full text-white bg-green-700 hover:opacity-90 transition-opacity px-8 text-sm py-3 font-medium backdrop-blur
                 ">
