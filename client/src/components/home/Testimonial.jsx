...
import { Book, NotebookIcon} from 'lucide-react';
...
const Testimonial = () => {
  ...
  return (
    <div id='testimonials' className='flex flex-col items-center justify-items-start min-h-[80vh] w-full scroll-mt-12'>
    <div className='flex flex-col items-center justify-items-start' >
     <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 border border-green-200 rounded-full px-4 py-1 w-auto">
        ...
        <Title
          ...
          description={'Hear from real users who landed their dream jobs with our resume builder. Discover how our platform made their job search easier, faster, and more successful.'}
        />
