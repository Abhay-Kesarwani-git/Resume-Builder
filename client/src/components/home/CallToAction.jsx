...
const CallToAction = () => {
  return (
    <div id='contact' className='flex flex-row flex-nowrap justify-between'><div className="max-w-5xl w-full p-20 text-gray-800 items-start">
            ...
            <p className="text-left mt-4">
                ...
                <a href="mailto:resume.abhay.com" className="text-green-600 hover:underline"> contact@resume.abhay.com</a>
            </p>
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    <svg className="text-green-500 bg-green-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
                        height="24" viewBox="0 0 24 24" fill="none" xmlns="httpz://www.w3.org/2000/svg">
                        <path
                    ...
                    <a href="contact@resumeui.com" className="text-green-600 font-semibold">
                        contact@resumeabhay.com
                    </a>
                </div>
                <div>
                    <svg className="text-green-500 bg-green-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
        ...
        <div className="size-[520px] rounded-full absolute blur-[300px] -z-10 bg-[#FBFFE1]"></div>
                <img className="max-w-sm w-full rounded-xl h-1/4 object-cover m-20"
