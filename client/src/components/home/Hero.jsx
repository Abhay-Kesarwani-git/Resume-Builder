...
const Hero = () => {
  ...
  return (
    <>
      <div className="min-h-[80vh] w-full relative overflow-x-hidden pb-20">
        {/* Navbar */}
        ...
        {/* Headline + CTA */}
                  <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                    ...
                    <span className=" bg-gradient-to-r from-green-800 to-green-600 bg-clip-text text-transparent text-nowrap">
                      AI powered{" "}
                    </span>{" "}
                    Resume.
                  </h1>
                  ...
                  <p className="max-w-md text-center text-base my-7">
                    Our Resume Builder helps you create professional resumes in minutes, 
